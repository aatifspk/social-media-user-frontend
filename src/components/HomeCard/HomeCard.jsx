...
const HomeCard = () => {
  ...
  return (
    <Card className=" border-b-2 border-gray-400 pb-5  shadow-none rounded-none w-[]100%">
      <div className='py-2 px-2 w-[100%] h-auto'>
        <div className="flex w-[100%]  items-center  gap-4">
          ...
          <div className='flex flex-row justify-between   items-center  w-[100%]'>
            <div >
              <span class="text-sm font-semibold antialiased  leading-tight flex items-center">Md Aatif<span> <BsDot /> </span> 2d</span>
      ...
      <CardFooter className={`${width < breakpoints.sm ? "px-3" : "p-0"}   h-auto `} >
        <div >
          <span class="text-sm font-semibold antialiased  leading-tight flex items-center mb-2">112 likes</span>
          <span class="text-sm font-semibold antialiased  leading-tight flex items-center mb-2 ">Md Aatif</span>
        </div>
        <div >
          <span class="text-sm font-light antialiased  leading-tight flex items-center">View all 40 comments</span>
        </div>
        <div className='relative'>
          <input onChange={() => setPostClickAble(true)} type="text"  className='w-[100%] border-none focus:outline-none focus:ring-0 ' placeholder='Add a comment... ' />
